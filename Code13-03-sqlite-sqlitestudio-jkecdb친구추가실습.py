...
def insertData() :
    ...
    con = sqlite3.connect("C:/sqlite/SQLiteStudio/jkecdb")  # DB가 저장된 폴더까지 지정
    cur = con.cursor()
...
def selectData() :
    ...
    con = sqlite3.connect("C:/JK/naverDB")  # DB가 저장된 폴더까지 지정
    cur = con.cursor()
    cur.execute("SELECT * FROM userTable")
    strData1.append("사용자ID"); strData2.append("사용자이름")
    strData3.append("이메일"); strData4.append("출생연도"); strData5.append("전화번호");
